  ...
  export default {
    ...
    methods: {
      onOk (evt) {
        ...
        } else if (this.openType === 'deleteTestHistoryOne') {
          this.EventBus.$emit(Constant.DELETE_TEST_HISTORY_ONE, this.item)
        ...
        } else if (this.openType === 'diagSubmit') {
          this.EventBus.$emit('SUBMIT_DIAGNOSIS')
